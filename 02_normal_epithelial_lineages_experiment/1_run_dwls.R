...
# single_cell_ref_path <- "mini_scRNA_ref.csv"
# single_cell_labels_path <- "mini_single_cell_labels.csv"
# bulk_mixture_path <- "mini_bulk.csv"
...
sc_labels <- sc.labels$celltype_hybrid
